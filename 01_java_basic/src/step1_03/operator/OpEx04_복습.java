// 2020-10-18 일 자습 20:05-20:13
package step1_03.operator;

public class OpEx04_복습 {
	...
	public static void main(String[] args) {
        ...
        System.out.println("[1] " + (15%3 == 0 ? true : false));
                
        //문제2) 100이 짝수이면 true 출력
        //힌트) 숫자를 2로 나눈 나머지가 0이면 짝수
        //      숫자를 2로 나눈 나머지가 1이면 홀수
        System.out.println("[2] " + (100%2 == 0 ? true : false));

        //문제3)아래돈중 1000원짜리 이상화폐를 제외한 1000원짜리가 3장 이상이면 true 출력
        int money = 178600;
        System.out.println("[3] " + ((((money%50000)%10000)%5000)/1000 >=3 ? true : false));
